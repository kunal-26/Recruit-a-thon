...
<div class="card 2" style="float:left; border-spacing: 50px; margin: 2.3%;">
  ...
  <div class="card_title">
    <form method="post" action="internship1.php">
...
"/>
    <input type="submit" value="<?php echo $b; ?>" name="b1" style="
	background-color:#44c767;
	border-radius:28px;
	border:1px solid #18ab29;
	display:inline-block;
