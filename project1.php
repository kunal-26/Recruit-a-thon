...
<div class="col-md-10 mx-auto">
    ...
    <h3 class="font-weight-bold text-dark">Project Description</h3>
...
$q1="select * from projectregisteration where enrollmentno='$e1'";
$q2="select * from projectregisteration where organisation='$name'";
//Fetch data
