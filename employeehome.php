...
<div class="header__logo"><img class="header__img" src="https://image.ibb.co/kcVou6/path3000.png"> <h1 class="header__title">Bricks<span class="header__light">.io</span></h1></div> 
  ...
  <div class="header__menu">
    <nav id="navbar" class="header__nav collapse">
      <ul class="header__elenco">
        ...
        <li class="header__el header__el--blue"><a href="appplication.php" class="btn btn--white">My Applications →</a></li>
 ...
 <li class="header__el header__el--blue"><a href="contactus.php" class="btn btn--white">Contact Us →</a></li>
        <li class="header__el header__el--blue"><a href="employeeprofile.php" class="btn btn--white">Hello <?php echo $e1;?> →</a></li>
...
" /> </div>
  <div class="card_title title-white">
    <p><a href="addjob.php" style="color:#FFF;">job Openings</a></p>
  </div>
</div>
...
<div class="card 4">
  ...
  <div class="card_title title-black">
    <p><a href="addproject.php" style="color:#FFF;">Projects</a></p>
  </div>
  </div>
  ...
  <div class="card_title title-white">
    <p><a href="addinternship.php" style="color:#FFF;">Internships</a></p>
  </div>
</div>
...
<div class="card 3">
  ...
  <div class="card_title">
    <p style="color:#FFF;"><a href="addhackathon.php" style="color:#FFF;">Hackathons</a></p>
  </div>
</div>
