...
<div class="header__logo"><img class="header__img" src="https://image.ibb.co/kcVou6/path3000.png"> <h1 class="header__title">Bricks<span class="header__light">.io</span></h1></div> 
  ...
  <form id="form1" name="form1" method="post" action="addjob1.php">
    ...
    <div class="form-group">
      <label id="email-label" for="email">Job Title</label>
      <input name="t3" class="form-control" placeholder="Enter Job Title" required />
    </div>
    ...
    <div class="form-group">
      <label id="email-label" for="email">Sallary</label>
      <input type="number" name="t6" class="form-control" placeholder="Enter Total Sallary" required />
    </div>
...
<div class="form-group">
      ...
      <label>
        <input type="radio" name="t9" value="3" class="input-radio" checked />Three</label>
     <label> <input type="radio" name="t9" value="4" class="input-radio" />Four</label>
      <label>
        <input type="radio" name="t9" value="5" class="input-radio" />Five</label>
    </div>
    <div class="form-group">
      <p>Round 1 details</p>
