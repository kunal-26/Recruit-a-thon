...
if($n==1)
{
  ...
  <form id="form1" name="form1" method="post" action="registerhackathon.php">
...
<div class="form-group">
     ...
     <label> <input type="radio" name="t5" value="Masters" class="input-radio" />Masters</label>
      <label>
        ...
        <div class="form-group">
      <label id="email-label" for="email">Event Name</label>
      <input readonly value="<?php echo $eventname;?>" name="t6" class="form-control" type="text"  required />
    </div>
