...
<?php
 ...
 if(isset($_POST["b1"]))
 {
	...
	$q1="insert into hackathon (name,description,statement,start,end,contact,prize,rounds,round1,round2,round3,round4,round5)
	 values
	
('$name',
'$description','$statement','$start','$end','$contact','$prize','$rounds','$round1','$round2','$round3','$round4','$round5')";
