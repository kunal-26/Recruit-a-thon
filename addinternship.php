...
<div class="header__logo"><img class="header__img" src="https://image.ibb.co/kcVou6/path3000.png"> <h1 class="header__title">Bricks<span class="header__light">.io</span></h1></div> 
  ...
  <form id="form1" name="form1" method="post" action="addinternship1.php">
    ...
    <div class="form-group">
      <label id="email-label" for="email">Intern Title</label>
      <input name="t3" class="form-control" placeholder="Enter Intern Title" required />
    </div>
    ...
    <div class="form-group">
      <label id="email-label" for="email">Stipend</label>
    ...
    <div class="form-group">
      ...
      <input type="text" name="t9" class="form-control" placeholder="Enter Duration" required />
    </div>
