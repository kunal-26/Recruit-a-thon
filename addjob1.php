...
<?php
 ...
 if(isset($_POST["b1"]))
 {
	...
	$q1="insert into job (name,description,title,jobdescription,contact,sallary,link,date,rounds,round1,round2,round3,round4,round5)
	 values
	
('$name',
'$description','$title','$jobdescription','$contact','$sallary','$link','$date','$rounds','$round1','$round2','$round3','$round4','$round5')";
